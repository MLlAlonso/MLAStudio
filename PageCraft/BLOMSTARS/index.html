...
<head>
    ...
    <!-- IMPORTANTE: reemplaza por tu dominio real -->
    <meta property="og:url" content="https://blomstars.com">
    <!-- IMPORTANTE: agrega una imagen real para compartir -->
...
<body>
    ...
    <div class="social-float">
        ...
        <a href="https://www.instagram.com/bloomstarsag" target="_blank" class="social-float__item">
            <img src="../assets/img/BLOMSTARS/instagram.png" alt="Instagram">
        </a>

        <a href="https://www.tiktok.com/@teambloomstars" target="_blank" class="social-float__item">
            <img src="../assets/img/BLOMSTARS/tiktok.png" alt="TikTok">
        </a>
    </div>
